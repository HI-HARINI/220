...
try:
    ...
    spawn_point = (world.get_map().get_spawn_points()[18])
    dropped_vehicle = world.spawn_actor(car_model, spawn_point)

    police_car_blueprint = get_blueprint_of_world.filter('police')[0]
    police_car_spawn_point =get_map().get_spawn_points()[15]
    ...
    police_car.apply_control(carla.VehicleControl(throttle=0.35, steer=-0.2))
